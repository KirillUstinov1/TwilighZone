...
public class PatrolEnemy : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        RaycastHit2D wallInfo = Physics2D.Raycast(frontDetection.position, moveDir, wallRayDist, whatIsWall);
        RaycastHit2D backWallInfo = Physics2D.Raycast(backDetection.position, -moveDir, wallRayDist, whatIsWall);
